        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-center relative z-10">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-4 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-primary-300">Bus Advertising</h1>
            </div>
            <p className="text-lg text-primary-200">Maximum Visibility on the Move</p>
          </div>
        </div>
      </section>
              ...
              <div className="mb-8">
                <div className="relative w-full h-64 bg-gradient-to-br from-primary-900/50 to-primary-800/30 border border-primary-800 rounded-lg overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <FiTruck className="text-primary-400" size={120} />
                  </div>
                  <div className="absolute bottom-4 left-4 right-4 text-center">
                    <p className="text-primary-200 text-sm font-medium">Bus Advertising Solutions</p>
                  </div>
                </div>
              </div>
              ...
              <div className="prose max-w-none">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div className="bg-primary-900/30 border border-primary-800 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-primary-200">Complete bus wrapping for maximum impact and brand recognition</p>
                  </div>
                  <div className="bg-primary-900/30 border border-primary-800 p-4 rounded-lg">
                    <h3 className="font-semibold text-primary-300 mb-2">Side Panel Advertising</h3>
                    <p className="text-sm text-primary-200">Strategic placement on bus sides for optimal visibility</p>
                  </div>
                  <div className="bg-primary-900/30 border border-primary-800 p-4 rounded-lg">
                    <h3 className="font-semibold text-primary-300 mb-2">Back Panel Advertising</h3>
                    <p className="text-sm text-primary-200">High-impact rear advertising for following traffic</p>
                  </div>
                  <div className="bg-primary-900/30 border border-primary-800 p-4 rounded-lg">
                    <h3 className="font-semibold text-primary-300 mb-2">Interior Bus Advertising</h3>
                    <p className="text-sm text-primary-200">Reach passengers during their commute with interior ads</p>
                  </div>
                </div>
