...
const portfolioItems = [
  {
    ...
    content: `
      ...
      <p>"The bus advertising campaign exceeded our expectations. The visibility and reach were outstanding, and we saw a significant increase in customer inquiries and store visits. Katyani Media's professional approach and attention to detail made this campaign a huge success." - Marketing Director, Client Company</p>
  ...
  },
  {
    ...
    content: `
      ...
      <h2>Client Testimonial</h2>
      <p>"Katyani Media transformed our annual conference into a powerful brand-building and lead generation event. Their attention to detail, professional execution, and strategic approach exceeded all our expectations. The results speak for themselves." - CEO, Client Company</p>
  ...
  },
  {
    ...
    content: `
      ...
      <h2>Client Testimonial</h2>
      <p>"The radio advertising campaign significantly boosted our brand awareness and customer traffic. Katyani Media's strategic approach and creative execution helped us reach our target audience effectively and drive real business results." - Marketing Manager, Client Company</p>
  ...
  },
  {
    ...
    content: `
      ...
      <h2>Client Testimonial</h2>
      <p>"The metro station campaign effectively reached our target audience of urban professionals and families. The increase in inquiries and property visits exceeded our expectations. Katyani Media's strategic approach and professional execution made this campaign a success." - Sales Director, Client Company</p>
  ...
  },
  {
    ...
    content: `
      ...
      <h2>Client Testimonial</h2>
      <p>"The pamphlet distribution campaign delivered exceptional results. The response rate and appointment bookings exceeded our expectations. Katyani Media's professional approach and attention to detail made this campaign highly successful." - Operations Manager, Client Company</p>
  ...
  },
  {
    ...
    content: `
      ...
      <h2>Client Testimonial</h2>
      <p>"The cycle advertising campaign perfectly aligned with our brand's sustainability values while effectively reaching our target audience. The innovative approach and professional execution made this campaign a standout success." - Brand Manager, Client Company</p>
